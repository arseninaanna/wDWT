...
f = open("./data/pan-plagiarism-corpus-2011/external-detection-corpus/source-document/part1/source-document00001.txt",
         encoding="utf-8-sig")
