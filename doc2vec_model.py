...
corpus = get_documents("/data/pan-plagiarism-corpus-2011/external-detection-corpus/source-document/part1")
...
f = open("/content/pan-plagiarism-corpus-2011/external-detection-corpus/source-document/part1/source-document00001.txt",
         encoding="utf-8-sig")
...
for i in range(1, 501):
    ...
    f = open(
        f"/content/pan-plagiarism-corpus-2011/external-detection-corpus/suspicious-document/part1/suspicious-document{vv}.txt",
        encoding="utf-8-sig")
    corpus_susp = f.read()
